...
| SOL | ✅ | ✅ | ✅ | ✅ | any SPL token of the original program — ✅; Token-2022 — 📅 |
...
10. ✅ **N.1 / N.2** ERC-20 and TRC-20, ✅ **N.3** jettons and SPL tokens (Token-2022 still receive-only).  
...
14. 🟡 New L1s — **XRP, XLM, ATOM, NEAR, DOT all receive + balance**, each pinned to its reference library or spec; **XLM, NEAR, XRP and ATOM send** (pinned to the Stellar Go SDK, near-api-js, xrpl.js and cosmjs); DOT send is its own later step.  
