...
14. 🟡 New L1s — **XRP, XLM, ATOM, NEAR, DOT all receive + balance**, each pinned to its reference library or spec; **XLM and NEAR send** (pinned to the Stellar Go SDK and near-api-js); send for the others is its own later step.  
