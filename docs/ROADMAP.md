...
14. 🟡 New L1s — **XRP, XLM, ATOM, NEAR, DOT all receive + balance**, each pinned to its reference library or spec; **XLM, NEAR and XRP send** (pinned to the Stellar Go SDK, near-api-js and xrpl.js); ATOM and DOT send are their own later steps.  
