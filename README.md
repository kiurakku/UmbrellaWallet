...
![Version](https://img.shields.io/badge/version-4.0.2-4B3F86)
...
**[⬇️ Installer (v4.0.2)](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-4.0.2.exe)** · **[Portable zip](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Portable-4.0.2.zip)** · [💖 Sponsor](https://github.com/sponsors/kiurakku) · [📣 Telegram](https://t.me/UmbrellaWallet) · [All releases](https://github.com/kiurakku/umbrella-wallet/releases)
...
|----------|---------|-------|
| **Windows** | [UmbrellaWallet-Setup-4.0.2.exe](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-4.0.2.exe) | Installer — choose install folder |
| **Windows** | [`UmbrellaWallet-Portable-4.0.2.zip`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Portable-4.0.2.zip) | Portable — unzip and run `Umbrella.exe` |
| **Linux** | [`UmbrellaWallet-4.0.2-linux-x64.tar.gz`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-4.0.2-linux-x64.tar.gz) | Unpack, run `./Umbrella.Wallet.App` — no install required |
