...
![Version](https://img.shields.io/badge/version-3.4.0-4B3F86)
...
**[⬇️ Installer (v3.4.0)](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-3.4.0.exe)** · **[Portable zip](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Portable-3.4.0.zip)** · [💖 Sponsor](https://github.com/sponsors/kiurakku) · [📣 Telegram](https://t.me/UmbrellaWallet) · [All releases](https://github.com/kiurakku/umbrella-wallet/releases)
...
|----------|---------|-------|
| **Windows** | [UmbrellaWallet-Setup-3.4.0.exe](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-3.4.0.exe) | Installer — choose install folder |
| **Windows** | [`UmbrellaWallet-Portable-3.4.0.zip`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Portable-3.4.0.zip) | Portable — unzip and run `Umbrella.exe` |
| **Linux** | [`UmbrellaWallet-3.4.0-linux-x64.tar.gz`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-3.4.0-linux-x64.tar.gz) | Unpack, run `./Umbrella.Wallet.App` — no install required |
