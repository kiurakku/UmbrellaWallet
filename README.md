...
![Version](https://img.shields.io/badge/version-2.8.8-4B3F86)
...
**[⬇️ Installer (v2.8.8)](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-2.8.8.exe)** · **[Portable zip](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-2.8.8-win-x64-portable.zip)** · [All releases](https://github.com/kiurakku/umbrella-wallet/releases)
...
|----------|---------|-------|
| **Windows** | [UmbrellaWallet-Setup-2.8.8.exe](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-Setup-2.8.8.exe) | Installer — choose install folder |
| **Windows** | [`UmbrellaWallet-2.8.8-win-x64-portable.zip`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-2.8.8-win-x64-portable.zip) | Portable — unzip and run `Umbrella.exe` |
| **Linux** | [`UmbrellaWallet-2.8.8-linux-x64.tar.gz`](https://github.com/kiurakku/umbrella-wallet/releases/latest/download/UmbrellaWallet-2.8.8-linux-x64.tar.gz) | Unpack, run `./Umbrella.Wallet.App` — no install required |
